...
function generateItem(listeItem){
    ...
    for (let i=0; i<listeItem.length ; i++){
        ...
        listUser.innerHTML += "<div class=\"item\">\n" +
            "                    <a href=\"\">\n" +
            "                        <div class=\"image\" style=\"background-image: url('../../couverture/"+listeItem[i].couverture+"')\"></div>\n" +
            "                    </a>\n" +
            "                    <div class=\"item-info\">\n" +
            "                        <h3>"+listeItem[i].title+"</h3>\n" +
            "                        <p><i class=\"far fa-clock\"></i>"+listeItem[i].dt_pub+"</p>\n" +
            "                    </div>\n" +
            "                    <div class=\"item-controller\">\n" +
            "                        <a href=\"PrepareUpdate.SongList?id="+listeItem[i].id+"\"><i class=\"fa fa-edit\"></i></a>\n" +
            "                        <a href=\"DeleteSong.SongCrud?id="+listeItem[i].id+"\"><i class=\"fa fa-trash-alt\"></i></a>\n" +
            "                    </div>\n" +
            "                </div>";
    }
}
...
function submitForm(form) {
    ...
    xhr.open("POST", "Search.SongList", true);
    xhr.send(formData);
}
