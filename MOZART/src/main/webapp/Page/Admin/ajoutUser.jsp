...
<div class="container">
    ...
    <div class="formulaire">
        <form action="InsertUser.UserCrud" method="post" enctype="multipart/form-data">
            <div class="info-perso">
                <div class="photo">
                    <div class="pdp">
                        <label>
                            <input required type="file" name="pdp" style="display: none;" accept="image/*" onchange="showBackground(this)">
