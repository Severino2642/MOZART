...
<%
    Song music = (Song) request.getAttribute("song");
...
<div class="container">
    ...
    <div class="formulaire">
        <form action="UpdateSong.SongCrud" method="post" enctype="multipart/form-data">
            <input type="hidden" name="id" value="<%=music.getId()%>">
            <div class="photo">
                <div class="couverture">
                    <label style="background-image: url('../../couverture/<%=music.getCouverture()%>')">
            ...
            <div class="music">
                <label>
                    <input type="file" name="contenue" style="display: none;" accept="audio/*">
                    <p> <i class="fa fa-music" id="music"></i> Your Song</p>
                </label>
            </div>
            <div class="info-perso">
                <div>
                    <input type="text" name="title" placeholder="Title" value="<%=music.getTitle()%>" required>
                    <input type="text" name="author" placeholder="Author" value="<%=music.getAuthor()%>" required>
                </div>
                <div>
