...
<div class="formulaire">
    <form action="LogIn.UserList" method="post">
        <div class="form-header">
            <h1>Log in to Mozart</h1>
            <nav>
                <a href="loginAdmin.jsp">
                    <p><i class="fa fa-user-shield"></i> <strong>Login as admin</strong></p>
                </a>
        ...
        <div class="form-footer">
            <p>Don't have an account ? <a href="User/signin.jsp">Sign up for Mozart</a></p>
        </div>
    </form>
</div>
<footer>
